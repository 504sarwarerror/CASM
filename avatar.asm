...
section .data
    ...
    avatar_U1path db "assets/avatar/AVATAR7.png", 0
    avatar_U2path db "assets/avatar/AVATAR8.png", 0
    avatar_D1path db "assets/avatar/AVATAR9.png", 0
    avatar_D2path db "assets/avatar/AVATAR10.png", 0
    move_speed dd 6
    avatar_r dd 0
    avatar_l dd 0
    avatar_b dd 0
...
section .bss
    ...
    avatar_U1texture resq 1
    avatar_U2texture resq 1
    avatar_D1texture resq 1
    avatar_D2texture resq 1
    avatar_x resd 1
    avatar_y resd 1
    avatar_rect resb 16
    avatar_frame resd 1
...
avatar_load:
    ...
    LOAD_IMAGE avatar_U1path, avatar_U1texture  
    LOAD_IMAGE avatar_U2path, avatar_U2texture
    LOAD_IMAGE avatar_D1path, avatar_D1texture
    LOAD_IMAGE avatar_D2path, avatar_D2texture
...
avatar_update:
    ...
    if eax == 0
        ...
        mov dword [avatar_u], 0
        mov dword [avatar_d], 0
        jmp .done
    endif
...
avatar_draw:
    ...
    DRAW_IMAGE avatar_b, avatar_Btexture, avatar_B1texture
    DRAW_IMAGE avatar_u, avatar_U1texture, avatar_U2texture
    DRAW_IMAGE avatar_d, avatar_D1texture, avatar_D2texture
